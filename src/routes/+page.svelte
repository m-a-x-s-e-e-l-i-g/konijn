<script lang="ts">    import { ArrowPathRoundedSquare, Sparkles } from '@steeze-ui/heroicons';
    ...
    function shoot() {
        ...
        if (weapons[$currentWeapon].name === 'pistol') {
            ...
            if (muzzleFlash) {
                // Show and animate muzzle flash at its defined SVG position
...
<div id="background">
    ...
    <!-- Muzzle flash positioned at the pistol barrel -->
    <g id="muzzle-flash" style="display: none;" transform="translate(330, 200)">
        <circle fill="#ffff00" r="8" opacity="0.9"/>
        <circle fill="#ff6600" r="6" opacity="0.8"/>
        <circle fill="#ffffff" r="4" opacity="0.7"/>
        <polygon fill="#ffff00" points="0,-12 4,-20 8,-16 12,-24 6,-8 0,-12" opacity="0.6"/>
        <polygon fill="#ffff00" points="0,-12 -4,-20 -8,-16 -12,-24 -6,-8 0,-12" opacity="0.6"/>
        <polygon fill="#ff6600" points="12,0 20,4 16,8 24,12 8,6 12,0" opacity="0.5"/>
        <polygon fill="#ff6600" points="-12,0 -20,4 -16,8 -24,12 -8,6 -12,0" opacity="0.5"/>
    </g>
</g></svg>
